export function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-30 scanlines relative overflow-hidden">
      ...
      {/* Floating pixels */}
      <div className="absolute top-20 left-10 w-4 h-4" style={{ background: 'rgb(var(--color-primary))', boxShadow: '0 0 20px rgb(var(--color-primary))' }} />
      <div className="absolute top-40 right-20 w-4 h-4" style={{ background: 'rgb(var(--color-secondary))', boxShadow: '0 0 20px rgb(var(--color-secondary))' }} />
      <div className="absolute bottom-40 left-20 w-4 h-4" style={{ background: 'rgb(var(--color-accent))', boxShadow: '0 0 20px rgb(var(--color-accent))' }} />
        ...
        <div className="mb-8 inline-block">
          <span 
            ...
            style={{ 
              ...
              textShadow: '0 0 10px rgb(var(--color-accent))'
            }}
          >
            &gt;&gt; READY_FOR_WORK &lt;&lt;
          </span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <a
            ...
            style={{ 
              ...
              boxShadow: '0 0 20px rgb(var(--color-primary)), inset 0 0 20px rgba(255, 255, 255, 0.2)',
